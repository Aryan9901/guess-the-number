...
#" alt="Project Banner">
  ...
  <h3 align="center">GUESS THE NUMBER GAME</h3>
   ...
   <div align="center">
       A dynamic web-based game built entirely in vanilla JavaScript. Users are prompted to guess a number between 1 and 20, receiving immediate feedback on each attempt. The game features a tracking system for guesses and congratulatory messages upon correct answers, providing an engaging user experience. Developed with HTML, CSS, and JavaScript for seamless functionality and interactivity.
    </div>
</div>
...
Developed a web-based guessing game using vanilla JavaScript. The game prompts the user to guess a number between 1 and 20. After each guess, the program provides feedback indicating whether the guess is too high or too low. Implemented logic to track the number of attempts and display a congratulatory message upon successful guessing. Utilized HTML, CSS, and JavaScript to create an interactive and engaging user experience.

If you're getting started and need assistance or face any bugs, feel free to raise an issue. It's a place where people help each other out.
